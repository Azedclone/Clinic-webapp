    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (account == null) {
            ...
            switch (account.getRole()) {
                case 0:
                    res.sendRedirect(req.getContextPath() + "/view/admin/admin.jsp");
                    break;
                case 2:
                    res.sendRedirect(req.getContextPath() + "/view/patient/patient.jsp");
                    break;
                case 1:
                    res.sendRedirect(req.getContextPath() + "/view/doctor/doctor.jsp");
                    break;
                default:
                    break;
            }
